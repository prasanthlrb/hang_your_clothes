...
Route::get('/unpaid-pdf', 'HomeController@unPaidPdf');
Route::get('/download-app', 'AutoCompleteController@downloadApp');
//services
...
Route::get('/get-change-weeks-time/{id}', 'OrderController@getChangeWeeksTime');
Route::get('/order-delete/{id}', 'OrderController@orderDelete');

Route::get('/change-status/{id}/{id1}', 'OrderController@changePaymentStatus');

Route::post('/update-pickup-time', 'OrderController@updatePickupTime');
