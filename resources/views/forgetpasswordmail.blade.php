							...
							<table class="widget w580" cellpadding="0" cellspacing="0" border="0" align="center" style="width: 580px;">
								<tr class="widget-header">
									<td height="55" style="border-bottom: 5px #2d87ba solid;">
										<h1 style="color: #2d87ba;font-family: Helvetica, Arial, sans-serif;font-size: 20px;font-weight: bold;text-transform: uppercase;line-height: 36px;padding-right: 20px;margin: 0;">Change Password Request</h1>
									</td>
								</tr>
								<tr>
								...
								<tr class="widget-content">
									<td>
										<h2 style="font-weight: bold;font-size: 16px;color: #2d87ba;">Your Change Password Request OTP is {{$customer->unique_id}}</h2>
									</td>
								</tr>
							</table>
							<!-- / .widget -->
